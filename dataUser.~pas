...
zqry1.SQL.Clear;
zqry1.SQL.Add('Update tabel_user set username= "'+edt1.Text+'",password="'+edt2.Text+'",level= "'+cmb1.Text+'",status= "'+cmb2.Text+'" where id_user ="'+id+'"');
zqry1.ExecSQL;
...
procedure TForm12.Bb6Click(Sender: TObject);
begin
